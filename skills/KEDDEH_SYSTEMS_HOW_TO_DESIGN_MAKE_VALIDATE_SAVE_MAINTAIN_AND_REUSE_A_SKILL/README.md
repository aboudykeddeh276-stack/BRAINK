...
| `REUSE_DOCTRINE.md` | Existing artifacts are source material, not authority — mechanic-level reuse rule |
| `NEGATIVE_CLAIM_BURDEN_OF_PROOF.md` | Negative capability claims carry the burden of proof — route-exhaustion rule |
