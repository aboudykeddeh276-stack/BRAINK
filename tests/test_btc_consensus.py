...
class BitcoinConsensusTests(unittest.TestCase):
    def test_genesis_header_known_answer(self) -> None:
        ...
        digest = btc.dsha256(header)
        self.assertEqual(digest[::-1].hex(), "000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f")
        self.assertLessEqual(int.from_bytes(digest, "little"), btc.compact_target("1d00ffff"))
    ...
    def test_mainnet_v0_bech32_payout_script(self) -> None:
        script = btc.segwit_scriptpubkey(VALID_BIP173)
    ...
    def test_candidate_is_bound_to_coinbase_and_block_body(self) -> None:
        template = {"version": 0x20000000, "previousblockhash": "11" * 32, "bits": "207fffff", "curtime": 1700000000, "height": 101, "coinbasevalue": 5_000_000_000, "transactions": []}
        candidate = btc.build_candidate(template, VALID_BIP173, bytes.fromhex("0102030405060708"), nonce=0)
    ...
    def test_extranonce_changes_coinbase_merkle_and_header(self) -> None:
        template = {"version": 1, "previousblockhash": "22" * 32, "bits": "207fffff", "curtime": 1700000001, "height": 102, "coinbasevalue": 5_000_000_000, "transactions": []}
        a = btc.build_candidate(template, VALID_BIP173, (1).to_bytes(8, "little"), 0)
        b = btc.build_candidate(template, VALID_BIP173, (2).to_bytes(8, "little"), 0)
    ...
    def test_wrong_hrp_is_rejected(self) -> None:
        with self.assertRaises(ValueError):
            btc.segwit_scriptpubkey(VALID_BIP173, "tb")
