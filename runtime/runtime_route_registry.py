...
DEFAULT_ROUTES={
 ...
 "antigravity-deploy":{"runtime_id":"runtime://braink/antigravity-deploy/1","runtime_class":"ONE_SHOT_JOB","argv":[SYSTEM_PYTHON,"deploy/braink-public/deploy_antigravity_live.py"],"dependencies":["braink://local/orchestrator","vfs://kex/root","KEX://SERVER/PUBLIC-GATEWAY"],"health_endpoint":None},
