...
final class BRAINKChatEngine: ObservableObject {
    ...
    private func buildLocalDeterministicProofPacket(path: String, externalReason: String?) -> String {
        ...
        let routingPath = BRAINKConstants.sourceFilePath("BRAINKChatEngine.swift")
    ...
    private func localProofFileReads(path: String) -> [String] {
        ...
        let fallback = [
            BRAINKConstants.sourceFilePath("BRAINKChatEngine.swift"),
            BRAINKConstants.sourceFilePath("BRAINKPlatformAPI.swift"),
            BRAINKConstants.sourceFilePath("BRAINKDeliveryAudit.swift"),
            BRAINKConstants.sourceFilePath("ModuleManifest.swift")
        ]
    ...
    private func localRuntimeEntrypointPath() -> String {
        let candidates = [
            BRAINKConstants.sourceFilePath("BRAINKChatBotApp.swift"),
            BRAINKConstants.sourceFilePath("BRAINKChatEngine.swift")
        ]
    ...
    private func runtimeTraceReport() -> String {
        ...
        - module manifest file: \(BRAINKConstants.sourceFilePath("ModuleManifest.swift"))
        - engine file: \(BRAINKConstants.sourceFilePath("BRAINKChatEngine.swift"))
        """
    }
    ...
    private func evaluateAlignmentStatus() -> String {
        ...
        let hasManifest = FileManager.default.fileExists(atPath: BRAINKConstants.sourceFilePath("ModuleManifest.swift"))
        let hasEngine = FileManager.default.fileExists(atPath: BRAINKConstants.sourceFilePath("BRAINKChatEngine.swift"))
